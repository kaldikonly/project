                    ...
                    <div className="news_card shadow-sm">
                        <div className="news_card_flex">
                            <div className="left-container">
                                <a href="#" className="source_name" id="rec_name">{f_news.f_Category}</a>
                                <span className="publication_time" id="rec_time"><Moment locale="ru"
                                    ...
                                    locale="ru" fromNow>{f_news.f_PublicationDate}</Moment>)
                                </span>
                            </div>
                            <div className="right_container">
                                <fieldset className="rating" id="rate">
                                    ...
                                    <input type="radio" id="star4" name="rating" value="4" checked="true"/>
                                    <label className="full" htmlFor="star4" title="Pretty good - 4 "></label>
                                    <input type="radio" id="star3" name="rating" value="3" checked="true"/>
                                    <label className="full" htmlFor="star3" title="Meh - 3 "></label>
                                    <input type="radio" id="star2" name="rating" value="2" checked="true"/>
                                    <label className="full" htmlFor="star2" title="Kinda bad - 2 "></label>
                                    <input type="radio" id="star1" name="rating" value="1" checked="true"/>
                                    <label className="full" htmlFor="star1" title="1"></label>
                        ...
                        <div className="news_body clearfix">
                            <div className="news_text">
                                <div className="news_text_container">
                                    ...
                                    <a className="news_title_link" id="rec_hd" href="#">{f_news.f_Title.split(" ", 8).join(" ")}</a>
                                    <p className="news_text">{f_news.f_Fulltext.slice(0, 225)}
                        ...
                        <div className="left_column">
                            <button className="news_btn news_card_more_info">Подробнее</button>
                            <a className="news_card_link" target="_blank" href={f_news.f_LinkToNews}>
                                <button className="news_btn news_card_read">Читать</button>
                            </a>
                        </div>
                    </div>
                </div>
